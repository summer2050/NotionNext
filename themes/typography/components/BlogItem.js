      ...
      <div className='flex'>
        ...
        <article className='article-info'>
          <h2 className='mb-2'>
            <SmartLink
              href={post.href}
              className='text-xl decoration-2 font-bold text-[var(--primary-color)] dark:text-white dark:hover:bg-white dark:hover:text-[var(--primary-color)]  duration-200 transition-all rounded-sm'>
